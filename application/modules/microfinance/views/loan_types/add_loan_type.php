	...
	<div class="container">
		...
		<div class="form-row">
			...
			<div class="form-group col-md-3">
				...
				<input type="number" onkeydown="return event.keyCode !== 69" onkeyup="minimumLoan()" name="minimum_loan_amount" id="minimum_loan_amount" class="form-control" value="<?php echo set_value('minimum_loan_amount')?>">
			</div>
			<div class="form-group col-md-3">
		...
		<div class="form-row">
			...
			<div class="form-group col-md-3">
				...
				<input type="number" onkeydown="return event.keyCode !== 69" name="minimum_number_of_installments" id="minimum_number_of_installments" onkeyup="minimumInstall()" class="form-control" value="<?php echo set_value('minimum_number_of_installments')?>">
			</div>
			<div class="form-group col-md-3">
		...
		<div class="form-row">
			...
			<div class="form-group col-md-3">
				...
				<input type="number" onkeydown="return event.keyCode !== 69" name="minimum_number_of_guarantors" id="minimum_number_of_guarantors" onkeyup="minimumGuarnt()" class="form-control" value="<?php echo set_value('minimum_number_of_guarantors')?>">
			</div>
			<div class="form-group col-md-3">
		...
		<div class="form-group">
			<div>
				...
				<input type="number" required onkeydown="return event.keyCode !== 69" step="0.01" name="interest_rate" class="form-control" value="<?php echo set_value('interest_rate')?>">
			</div>
		</div>
		<div class="row">
			</br>
