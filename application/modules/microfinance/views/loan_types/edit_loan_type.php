    ...
    <div class="card-body">
        ...
        <div class="form-row">
            <div class="form-group col-md-3">
                ...
                <input type="number" name="maximum_loan_amount" id="maximum_loan_amount" onkeydown="return event.keyCode !== 69" onkeyup="maximumLoan()" value="<?php echo $maximum_loan_amount; ?>"
                    class="form-control">
            </div>
            <div class="form-group col-md-3">
                <label for='minimum_loan_amount'>Minimum loan amount: </label>
                <input type="number" name="minimum_loan_amount" id="minimum_loan_amount" onkeydown="return event.keyCode !== 69" onkeyup="maximumLoan()" value="<?php echo $minimum_loan_amount; ?>"
                    class="form-control">
            </div>
            <div class="form-group col-md-3">
                <label for='custom_loan_amount'>Custom loan amount: </label>
                <input type="number" name="custom_loan_amount" onkeydown="return event.keyCode !== 69" value="<?php echo $custom_loan_amount; ?>"
                    class="form-control">
            </div>
        </div>
        <div class="form-row">
